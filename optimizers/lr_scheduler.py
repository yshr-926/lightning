...
class WarmupPolynomialLR(_LRScheduler):
    def __init__(self, optimizer, total_iters=5, warmup_epochs=2, warmup_start_lr=0.0, power=1.0, last_epoch=-1):
...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    ...
    def __init__(self, optimizer: Optimizer, warmup_epochs, max_epochs,
